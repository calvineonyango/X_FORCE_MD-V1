...
zokou({ nomCom: "co", reaction: "🧒", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "xforxe", reaction: "🙆", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
